...
export const TRANSLATABLE_FIELDS: [string, string][] = [
  ...
  ['type', 'type_en'],
  ['heating', 'heating_en'],
  ['energy_sources', 'energy_sources_en'],
  ['energy_consumption', 'energy_consumption_en'],
  ['energy_cert', 'energy_cert_en'],
  ['parking', 'parking_en'],
  ['elevator', 'elevator_en'],
  ['listed_building', 'listed_building_en'],
  ['renovation', 'renovation_en'],
  ['rented', 'rented_en'],
  ['rental_income', 'rental_income_en'],
  ['deposit', 'deposit_en'],
  ['district', 'district_en'],
  ['floor', 'floor_en'],
  ['available_from', 'available_from_en'],
  ['year_built', 'year_built_en'],
  ['would_buy', 'would_buy_en'],
  ['zone_rating', 'zone_rating_en'],
];
